            ...
            ZStack {
                ...
                VStack(spacing: 0) {
                    Image("welcome185")
                        .resizable()
                        .scaledToFill()
                        .frame(maxWidth: 428, maxHeight: 642, alignment: .top)
                        .mask(
                            LinearGradient(
                ...
                VStack(alignment: .leading, spacing: 12) {
                    Text("Access to Full official study\nguide")
                        .foregroundStyle(.white)
                        .font(.system(size: 24, weight: .semibold))
                    Text("Study the latest version of Federation of\nThe Armed Services Vocational Aptitude\nBettery (ASVAB) and learn everything you\nneed to know for the test")
                        .foregroundStyle(.white)
